...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(CHAR_SEL_GUID_BY_NAME, "SELECT guid FROM characters WHERE name = ?", CONNECTION_SYNCH);
    ...
    // Account data
    PREPARE_STATEMENT(CHAR_SEL_TUTORIALS, "SELECT type, time, data FROM account_data WHERE accountId = ?", CONNECTION_SYNCH)
