...
class DatabaseWorkerPool
{
    public:
        ...
        bool Open(const std::string& infoString, uint8 async_threads, uint8 synch_threads)
        {
            ...
            sLogMgr->WriteLn(SQLDRIVER_LOG, "Opening DatabasePool '%s'. Asynchronous connections: %u, synchronous connections: %u.",
            ...
            if (res)
                sLogMgr->WriteLn(SQLDRIVER_LOG, "DatabasePool '%s' opened successfully. %u total connections running.", GetDatabaseName(),
        ...
        void Close()
        {
            sLogMgr->WriteLn(SQLDRIVER_LOG, "Closing down DatabasePool '%s'.", GetDatabaseName());
            ...
            sLogMgr->WriteLn(SQLDRIVER_LOG, "Asynchronous connections on DatabasePool '%s' terminated. Proceeding with synchronous connections.",
                GetDatabaseName());
            ...
            sLogMgr->WriteLn(SQLDRIVER_LOG, "All connections on DatabasePool '%s' closed.", GetDatabaseName());
        }
