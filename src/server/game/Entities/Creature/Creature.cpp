...
void Creature::SaveToDB(uint32 mapid, uint8 spawnMask, uint32 phaseMask)
{
    ...
    stmt->setFloat(index++, spawnPos.GetPositionX());
    stmt->setFloat(index++, spawnPos.GetPositionY());
    stmt->setFloat(index++, spawnPos.GetPositionZ());
    stmt->setFloat(index++, spawnPos.GetOrientation());
