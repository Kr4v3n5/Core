...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_MAX_HONOR_POINTS] = ConfigMgr::GetIntDefault("MaxHonorPoints", 400000);
    ...
    m_int_configs[CONFIG_START_JUSTICE_POINTS] = ConfigMgr::GetIntDefault("StartArenaPoints", 0);
    ...
    if (reload)
    {
        uint32 val = ConfigMgr::GetIntDefault("Expansion", MAX_EXPANSION);
        ...
        m_int_configs[CONFIG_EXPANSION] = ConfigMgr::GetIntDefault("Expansion", MAX_EXPANSION);
    ...
    m_bool_configs[CONFIG_AUTO_WEEK_RESET]                           = ConfigMgr::GetBoolDefault("Arena.AutoWeekReset", true);
